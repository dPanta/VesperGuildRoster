...
You can clearly see whos in your group in the roster window (background color changes).
...
Venture Guild includes a full replacement for the default bags UI.
...
- Or use the slash command: `/vg` (or you can create a macro for /vg and keybind it)
...
## Do you have a feature request? Put it in the comments! :)
