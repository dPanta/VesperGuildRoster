...
local defaults = {
    ...
    ADDON_LOADED_MESSAGE = "VesperGuild loaded successfully!",
    ...
    CONFIG_FONT_MENU_TITLE = "VesperGuild Font",
    ...
    MINIMAP_TOOLTIP_TITLE = "VesperGuild",
    ...
    SLASH_COMMAND_HELP = "Open VesperGuild window",
    SLASH_USAGE = "Usage: /vg [config|reset|sync|debug|keys|bestkeys]",
    STATUS_AFK = "AFK",
    STATUS_DND = "DND",
