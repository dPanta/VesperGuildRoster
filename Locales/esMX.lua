...
local translations = {
    ADDON_LOADED_MESSAGE = "vesperTools se cargo correctamente.",
    ALL_FRAME_POSITIONS_RESET = "Se restablecieron todas las posiciones de las ventanas.",
    ...
    CONFIG_ADD_BUTTON = "Agregar",
    CONFIG_ADD_TOY_BY_NAME = "Agregar juguete por nombre",
    ...
    CONFIG_NO_OWNED_TOY_MATCH = "Ningun juguete que posees coincide con ese nombre.",
    ...
    UTILITY_TOYS_HINT = "Pasar el mouse: abrir menu",
